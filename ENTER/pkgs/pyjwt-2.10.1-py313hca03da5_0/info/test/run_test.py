#  tests for pyjwt-2.10.1-py313hca03da5_0 (this is a generated file);
print('===== testing package: pyjwt-2.10.1-py313hca03da5_0 =====');
...
print('===== pyjwt-2.10.1-py313hca03da5_0 OK =====');
print("import: 'jwt'")
import jwt
